    ...
    return (
        <div className="flex flex-col items-center gap-6 ">
            ...
            <div className="flex flex-wrap gap-4 justify-center md:justify-start">
                ...
                <div className="flex gap-4 items-center">
                    <Button className="w-max md:w-auto px-2 py-2 md:py-2" onClick={generateOutput}>Generate</Button>
                    <Button className="w-max md:w-auto px-2 py-2 md:py-2" onClick={() => setGuideText("")}>Clear text</Button>
                    <PrintButton className="w-max md:w-auto px-2 py-2 md:py-2" disabled={!guideOutput} />
                </div>
            </div>
